...
public class DoctorController
{
	...
	public ResponseEntity<Doctor> findAppointmentsByDoctorIdAndDate(@PathVariable int doctorId,@PathVariable LocalDate doctorAppointmentDate){
		System.out.println(doctorId+" "+doctorAppointmentDate);
		return new ResponseEntity<Doctor>(doctorService.getAppointmentsByDoctorIdAndDate(doctorId, doctorAppointmentDate),HttpStatus.OK);
	}
	...
	public HttpStatus modifyCustomerDetails(@RequestBody Doctor doctor) {
		if(doctorService.addOrModifyDoctor(doctor))
			return HttpStatus.OK;
		return HttpStatus.NOT_MODIFIED;
	}
